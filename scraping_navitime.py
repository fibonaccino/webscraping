...
def main():
    ...
    for i in range(1,48):
        ...
        pagewk = {1}
        while sw:
            # res = requests.get(f"https://www.navitime.co.jp/category/0604001/{ken}/?page={num}")  # 温泉
            res = requests.get(f"https://www.navitime.co.jp/category/0705002/{ken}/?page={num}")    # 神社
        ...
        # print(data)
        with open('onsen_list.csv', 'w') as f:
            writer = csv.writer(f)
